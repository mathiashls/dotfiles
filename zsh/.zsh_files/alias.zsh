...
alias ifsc='cd /Users/mathias/Documents/code/IFSC'
...
alias upserver='update_server.sh'
alias upsour='update_console.sh'
alias upconsole='update_console.sh'
alias bwatch='watch_konf.sh'
